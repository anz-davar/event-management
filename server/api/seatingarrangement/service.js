...
//       // Find an accessible table with enough space
//       const accessibleTableEntry = accessibleTables.find(t =>
...
//           }
//
//           // If not possible, seat at any available table
//           if (!seated) {
...
//       // Find a table with enough space for the entire family
...
//         const sortedTables = Object.values(tableAssignments)
//           .sort((a, b) => (b.maxSeats - b.seatsUsed) - (a.maxSeats - a.seatsUsed));
//
//         family.forEach(guest => {
//           // Find table with most available seats
//           const tableEntry = sortedTables.find(t => t.seatsUsed < t.maxSeats);
//           if (tableEntry) {
//             const seatNumber = tableEntry.seatsUsed + 1;
//             const seat = {
//               EventTableID: tableEntry.table.EventTableID,
...
//       });
//
//       // --- Family members logic (second highest priority) ---
